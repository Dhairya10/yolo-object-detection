...
ap.add_argument("-t", "--threshold", type=float, default=0.3,
	help="threshold when applying non-max suppression")
...
# laoding the YOLO object detector trained on COCO dataset (80 classes)
...
if len(idxs) > 0:
	...
	for i in idxs.flatten():
		...
		# passing the image along with the top-left and bottom right corner of the rectangle
