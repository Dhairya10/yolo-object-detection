...
try:
	#### imutils.is_cv2() is used to check the OpenCV version. 
    #### It returns a boolean value.

	prop = cv2.cv.CV_CAP_PROP_FRAME_COUNT if imutils.is_cv2() \
		else cv2.CAP_PROP_FRAME_COUNT

	#### vs.get() is used to return a specified VideoCapture property.
	#### We pass the identity of the property and here the identity is determined by prop
